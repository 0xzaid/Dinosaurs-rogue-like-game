...
//        gameMap.at(1, 1).addItem(rocket);
        ...
        MartianItem rocket = new MartianItem("Rocket", '^', false);
        rocket.addAction(new MoveActorAction(mars.at(7, 2), "to Mars!"));
        gameMap.at(2, 4).addItem(rocket);

        // changes by Jason
        MartianItem rocket2 = new MartianItem("Rocket2", '^', false);
        rocket.addAction(new MoveActorAction(gameMap.at(2, 3), "to Map!"));
        mars.at(9, 1).addItem(rocket2);
